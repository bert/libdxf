...
DxfViewport *dxf_viewport_set_z0 (DxfViewport *viewport, double z0);
...
double dxf_viewport_get_y1 (DxfViewport *viewport);
...
double dxf_viewport_get_z2 (DxfViewport *viewport);
DxfViewport *dxf_viewport_set_z2 (DxfViewport *viewport, double z2);
...
DxfViewport *dxf_viewport_set_y3 (DxfViewport *viewport, double y3);
