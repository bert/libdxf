...
/*!
 * \brief Set the center point \c p0 of a DXF \c VIEWPORT entity.
 *
...
/*!
 * \brief Get the Y-value of the center point \c y0 of a DXF \c VIEWPORT
 * entity.
 *
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (viewport->p0->y0);
}


/*!
 * \brief Set the Y-value of the center point \c y0 of a DXF \c VIEWPORT
 * entity.
 *
 * \return a pointer to \c viewport when successful, or \c NULL when an
 * error occurred.
...
/*!
 * \brief Get the X-value of the target point \c x1 of a DXF \c VIEWPORT
 * entity.
 *
 * \return the X-value of the target point \c x1.
 */
double
dxf_viewport_get_x1
(
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (viewport->p1->x0);
}


/*!
 * \brief Set the X-value of the target point \c x1 of a DXF \c VIEWPORT
 * entity.
 *
 * \return a pointer to \c viewport when successful, or \c NULL when an
 * error occurred.
...
(
        DxfViewport *viewport,
                /*!< a pointer to a DXF \c VIEWPORT entity. */
        double x1
                /*!< the X-value of the target point \c x1 of a DXF
                 * \c VIEWPORT entity. */
)
{
#ifdef DEBUG
...
/*!
 * \brief Get the Y-value of the direction from target point \c y2 of a
 * DXF \c VIEWPORT entity.
 *
 * \return the Y-value of the direction from target point \c y2.
 */
double
dxf_viewport_get_y2
(
...
/*!
 * \brief Set the Y-value of the direction from target point \c y2 of a
 * DXF \c VIEWPORT entity.
 *
 * \return a pointer to \c viewport when successful, or \c NULL when an
 * error occurred.
...
/*!
 * \brief Get the X-value of the view center point \c x3 of a DXF
 * \c VIEWPORT entity.
 *
 * \return the X-value of the view center point \c x3.
 */
double
dxf_viewport_get_x3
(
...
/*!
 * \brief Set the X-value of the view center point \c x3 of a
 * DXF \c VIEWPORT entity.
 *
 * \return a pointer to \c viewport when successful, or \c NULL when an
 * error occurred.
...
(
        DxfViewport *viewport,
                /*!< a pointer to a DXF \c VIEWPORT entity. */
        double x3
                /*!< the X-value of the view center point \c x3 of a DXF
                 * \c VIEWPORT entity. */
)
{
#ifdef DEBUG
...
/*!
 * \brief Get the X-value of the snap spacing \c x5 of a DXF
 * \c VIEWPORT entity.
 *
 * \return the X-value of the snap spacing \c x5.
 */
double
dxf_viewport_get_x5
(
...
/*!
 * \brief Set the X-value of the snap spacing \c x5 of a
 * DXF \c VIEWPORT entity.
 *
 * \return a pointer to \c viewport when successful, or \c NULL when an
 * error occurred.
...
(
        DxfViewport *viewport,
                /*!< a pointer to a DXF \c VIEWPORT entity. */
        double x5
                /*!< the X-value of the snap spacing \c x5 of a DXF
                 * \c VIEWPORT entity. */
)
{
#ifdef DEBUG
...
/*!
 * \brief Get the X-value of the grid spacing \c x6 of a DXF
 * \c VIEWPORT entity.
 *
 * \return the X-value of the grid spacing \c x6.
 */
double
dxf_viewport_get_x6
(
...
/*!
 * \brief Set the X-value of the grid spacing \c x6 of a
 * DXF \c VIEWPORT entity.
 *
 * \return a pointer to \c viewport when successful, or \c NULL when an
 * error occurred.
...
(
        DxfViewport *viewport,
                /*!< a pointer to a DXF \c VIEWPORT entity. */
        double x6
                /*!< the X-value of the grid spacing \c x6 of a DXF
                 * \c VIEWPORT entity. */
)
{
#ifdef DEBUG
