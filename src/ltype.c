 ...
 * \file ltype.c
 *
 * \author Copyright (C) 2008, 2012, 2014, 2015, 2017
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (ltype->complex_y_offset[i]);
}
...
)
{
        ...
        ltype->complex_y_offset[i] = complex_y_offset;
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ltype);
...
/*!
 * \brief Get the \c complex_scale indexed by \c i from a DXF
 * \c LTYPE entity.
 *
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (ltype->complex_scale[i]);
}


/*!
 * \brief Set the \c complex_scale for index \c i for a DXF
 * \c LTYPE entity.
 */
DxfLType *
...
(
        ...
        double complex_scale
                /*!< a double containing the \c complex_scale for
                 * index \c i of the entity. */
)
{
#if DEBUG
        ...
        ltype->complex_scale[i] = complex_scale;
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ltype);
...
/*!
 * \brief Get the \c complex_shape_number indexed by \c i from a DXF
 * \c LTYPE entity.
 *
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (ltype->complex_shape_number[i]);
}
