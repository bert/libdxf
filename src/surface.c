...
/*!
 * \brief Get the first value of the transform matrix of extruded entity
 * \c transform_matrix of a DXF extruded \c SURFACE entity.
 *
 * \return the first value of the transform matrix of extruded entity
 * \c transform_matrix.
 */
double
dxf_surface_extruded_get_transform_matrix_value
(
        DxfSurfaceExtruded *extruded_surface
                /*!< a pointer to a DXF extruded \c SURFACE entity. */
)
{
        ...
        DXF_DEBUG_END
#endif
        return (extruded_surface->transform_matrix->value);
}


/*!
 * \brief Set the value of the transform matrix \c transform_matrix of
 ...
 */
DxfSurfaceExtruded *
dxf_surface_extruded_set_transform_matrix_value
(
        DxfSurfaceExtruded *extruded_surface,
                /*!< a pointer to a DXF extruded \c SURFACE entity. */
        double value
                /*!< the value of the transform matrix
                 * \c transform_matrix of a DXF
                 * extruded \c SURFACE entity. */
)
{
#ifdef DEBUG
        ...
        extruded_surface->transform_matrix->value = value;
#if DEBUG
        DXF_DEBUG_END
#endif
        return (extruded_surface);
