 ...
 * 2019, 2020, 2021, 2025, 2026 by Bert Timmerman <bert.timmerman@xs4all.nl>.
 *
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double elevation
                /*!< [in] the \c elevation to be set for the entity. */
)
{
#if DEBUG
        DXF_DEBUG_BEGIN
...
(
        ...
        char *dictionary_owner_soft
                /*!< [out] a pointer to a \c dictionary_owner_soft. */
)
{
#if DEBUG
        DXF_DEBUG_BEGIN
...
(
        ...
        char *object_owner_soft
                /*!< [out] a pointer to \c object_owner_soft. */
)
{
#if DEBUG
        DXF_DEBUG_BEGIN
...
)
{
        ...
        plot_style_name = strdup (face->plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (EXIT_SUCCESS);
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        char *plot_style_name
                /*!< [in] a string containing the \c plot_style_name for the
                 * entity. */
)
{
#if DEBUG
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double z0
                /*!< [in] the Z-value of the base point \c z0 of a DXF
                 * \c 3DFACE entity. */
)
{
#ifdef DEBUG
...
(
        Dxf3dface *face,
                /*!< [in] a pointer to a DXF \c 3DFACE entity. */
        double *x1
                /*!< [out] a pointer to the X-value of the first alignment
                 * point \c x1 of a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
        DXF_DEBUG_BEGIN
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double x1
                /*!< [in] the X-value of the first alignment point \c x1 of a
                 * DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
...
(
        Dxf3dface *face,
                /*!< [in] a pointer to a DXF \c 3DFACE entity. */
        double *z1
                /*!< [out] a pointer to the Z-value of the first alignment
...
(
        Dxf3dface *face,
                /*!< [in] a pointer to a DXF \c 3DFACE entity. */
        double *x2
                /*!< [out] a pointer to the X-value of the second
                 * alignment point \c x2 of a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
        DXF_DEBUG_BEGIN
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double x2
                /*!< [in] the X-value of the second alignment point \c x2 of
                 * a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
...
(
        Dxf3dface *face,
                /*!< [in] a pointer to a DXF \c 3DFACE entity. */
        double *z2
                /*!< [out] a pointer to the Z-value of the second
                 * alignment point \c z2 of a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
        DXF_DEBUG_BEGIN
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double z2
                /*!< [in] the Z-value of the second alignment point \c z2 of
                 * a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
...
(
        Dxf3dface *face,
                /*!< [in] a pointer to a DXF \c 3DFACE entity. */
        double *x3
                /*!< [out] a pointer to the X-value of the third
                 * alignment point \c x3 of a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
        DXF_DEBUG_BEGIN
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double x3
                /*!< [in] the X-value of the third alignment point \c x3
                 * of a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
        DXF_DEBUG_BEGIN
...
(
        Dxf3dface *face,
                /*!< [in] a pointer to a DXF \c 3DFACE entity. */
        double *z3
                /*!< [out] a pointer to the Z-value of the third
                 * alignment point \c z3 of a DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
        DXF_DEBUG_BEGIN
...
(
        Dxf3dface *face,
                /*!< [in,out] a pointer to a DXF \c 3DFACE entity. */
        double z3
                /*!< [in] the Z-value of the third alignment point \c z3 of a
                 * DXF \c 3DFACE entity. */
)
{
#ifdef DEBUG
