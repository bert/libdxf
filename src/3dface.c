...
(
        Dxf3dface *face
                /*!< a pointer to a DXF \c FACE entity. */
)
{
#if DEBUG
        DXF_DEBUG_BEGIN
...
)
{
        ...
        switch (inheritance)
        {
                ...
                case 1:
                        if (face->linetype != NULL)
                        {
                                p1->linetype = strdup (face->linetype);
                        }
                        if (face->layer != NULL)
                        {
                                p1->layer = strdup (face->layer);
                        }
                        p1->thickness = face->thickness;
                        p1->linetype_scale = face->linetype_scale;
                        p1->visibility = face->visibility;
                        p1->color = face->color;
                        p1->paperspace = face->paperspace;
                        if (face->dictionary_owner_soft != NULL)
                        {
                                p1->dictionary_owner_soft = strdup (face->dictionary_owner_soft);
                        }
                        if (face->dictionary_owner_hard != NULL)
                        {
                                p1->dictionary_owner_hard = strdup (face->dictionary_owner_hard);
                        }
                        break;
                default:
                        fprintf (stderr,
...
)
{
        ...
        switch (inheritance)
        {
                ...
                case 1:
                        if (face->linetype != NULL)
                        {
                                p2->linetype = strdup (face->linetype);
                        }
                        if (face->layer != NULL)
                        {
                                p2->layer = strdup (face->layer);
                        }
                        p2->thickness = face->thickness;
                        p2->linetype_scale = face->linetype_scale;
                        p2->visibility = face->visibility;
                        p2->color = face->color;
                        p2->paperspace = face->paperspace;
                        if (face->dictionary_owner_soft != NULL)
                        {
                                p2->dictionary_owner_soft = strdup (face->dictionary_owner_soft);
                        }
                        if (face->dictionary_owner_hard != NULL)
                        {
                                p2->dictionary_owner_hard = strdup (face->dictionary_owner_hard);
                        }
                        break;
                default:
                        fprintf (stderr,
...
)
{
        ...
        switch (inheritance)
        {
                ...
                case 1:
                        if (face->linetype != NULL)
                        {
                                p3->linetype = strdup (face->linetype);
                        }
                        if (face->layer != NULL)
                        {
                                p3->layer = strdup (face->layer);
                        }
                        p3->thickness = face->thickness;
                        p3->linetype_scale = face->linetype_scale;
                        p3->visibility = face->visibility;
                        p3->color = face->color;
                        p3->paperspace = face->paperspace;
                        if (face->dictionary_owner_soft != NULL)
                        {
                                p3->dictionary_owner_soft = strdup (face->dictionary_owner_soft);
                        }
                        if (face->dictionary_owner_hard != NULL)
                        {
                                p3->dictionary_owner_hard = strdup (face->dictionary_owner_hard);
                        }
                        break;
                default:
                        fprintf (stderr,
