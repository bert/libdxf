...
)
{
        ...
        {
                fprintf (stderr,
                  (_("Warning in %s () a negative linetype scale value was passed.\n")),
                  __FUNCTION__);
        }
...
)
{
        ...
        {
                fprintf (stderr,
                  (_("Warning in %s () a negative visibility value was passed.\n")),
                  __FUNCTION__);
        }
        if (visibility > 1)
        {
                fprintf (stderr,
                  (_("Warning in %s () an out of range visibility value was passed.\n")),
                  __FUNCTION__);
        }
